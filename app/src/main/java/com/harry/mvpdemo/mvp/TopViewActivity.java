...
import com.harry.mvpdemo.R;
import com.harry.mvpdemo.adapter.AfRecyclerAdapter;
import com.harry.mvpdemo.adapter.AfViewHolder;
...
import com.harry.mvpdemo.refresh.SwipyRefreshLayoutDirection;
import com.harry.mvpdemo.util.AppUtils;
import com.harry.mvpdemo.view.FlowLayout;
import com.harry.mvpdemo.view.RefreshRecyclerView;
import com.harry.mvpdemo.view.RoundButton;
    ...
    private class ListAdapter extends AfRecyclerAdapter<MovieResponse, MyViewHolder> {
        ...
        public void onUpdateView(MyViewHolder holder, MovieResponse data, int position) {
            ...
            for (String genre : data.genres) {
                RoundButton tag = (RoundButton) View.inflate(TopViewActivity.this, R.layout.layout_tag, null);
